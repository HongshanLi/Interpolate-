// display the detail info of a group and class
...
export class EntityDetailComponent implements OnInit {
  ...
  public updatingEntityInfo = false;
  ...
  public userCanUpload = true;
  public userName: string;


  public panel = 'entityInfo';
  public message: string;
  public searchPlaced = false;
  ...
  displayInContext(ann: Annotation) {
    ...
    let docIdx = -1;
    for (const doc of this.activatedDocs) {
...
// documents
  getFile(doc: Document) {
    ...
    let docIdx = -1;
    for (const activatedDoc of this.activatedDocs) {
